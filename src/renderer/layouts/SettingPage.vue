  ...
  <div id="setting-page">
    ...
    <el-row style="padding-top: 22px;" class="main-content">
        ...
        <el-menu
          ...
          <el-menu-item index="upload">
           ...
           <el-menu-item index="acceptance">
            <i class="el-icon-upload"></i>
            <span slot="title">受理区</span>
          </el-menu-item>
           <el-menu-item index="undertake">
            <i class="el-icon-upload"></i>
            <span slot="title">承接区</span>
          </el-menu-item>
           <el-menu-item index="make">
            <i class="el-icon-upload"></i>
            <span slot="title">制作区</span>
          </el-menu-item>
           <el-menu-item index="deliver">
            <i class="el-icon-upload"></i>
            <span slot="title">交付区</span>
          </el-menu-item>
           <el-menu-item index="query">
            <i class="el-icon-upload"></i>
            <span slot="title">查询区</span>
          </el-menu-item>
           <el-menu-item index="statistics">
            <i class="el-icon-upload"></i>
            <span slot="title">统计区</span>
          </el-menu-item>
      ...
      <el-col
        ...
        <transition name="sealgo-fade" mode="out-in">
          <keep-alive>
    ...
    <el-dialog
      ...
      top="10vh"
    >
      SealGo 是免费开源的软件，如果你喜欢它，对你有帮助，不妨请我喝杯咖啡？
...
export default {
  ...
  data () {
    ...
    return {
      clientName: process.env.NODE_ENV === 'production' ? pkg.build.productName : '印章备案客户端',
      ...
      const template = [
        {
          ...
          click () {
            dialog.showMessageBox({
              title: 'SealGo',
              message: 'SealGo',
              detail: `Version: ${pkg.version}\nAuthor: ${pkg.author}\nGithub: https://github.com/foryourfuture/SealGo`
            })
          }
        },
        {
