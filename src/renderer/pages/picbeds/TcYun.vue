...
export default {
  ...
  methods: {
    ...
    openWiki () {
      this.$electron.remote.shell.openExternal('https://github.com/foryourfuture/SealGo/wiki/%E8%AF%A6%E7%BB%86%E7%AA%97%E5%8F%A3%E7%9A%84%E4%BD%BF%E7%94%A8#腾讯云cos')
    }
  }
}
</script>
