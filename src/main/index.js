...
import sealgoCoreIPC from './utils/sealgoCoreIPC'
...
const createSettingWindow = () => {
  const options = {
    ...
    fullscreenable: false,
    resizable: false,
    title: process.env.NODE_ENV === 'production' ? pkg.build.productName : '上海市印章客户端',
    vibrancy: 'ultra-dark',
    transparent: true,
