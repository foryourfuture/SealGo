<template lang='pug'>
  #app(v-cloak)
    #header
      .mask
      img.logo(src="~icons/256x256.png", alt="SealGo")
      h1.title SealGo
        small(v-if="version") {{ version }}
      h2.desc 图片上传+管理新体验
      button.download(@click="goLink('https://github.com/Molunerfinn/sealgo/releases')") 免费下载
      button.download(@click="goLink('https://sealgo.github.io/SealGo-Doc/zh/guide/')") 查看文档
      h3.desc
    ...
    return {
      ...
      itemList: [
        ...
        },
        {
          ...
          title: '插件系统',
          desc: '2.0版本开始支持插件系统，让SealGo发挥无限潜能，成为一个极致的效率工具。'
        }
      ]
    }
  },
